...
if [ -n "$1" ];then
	...
	file_overlap="/projects/btl_scratch/aafshinfard/projects/physlr2/physlr/data/f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.nn.edges"
fi
if [ -n "$2" ];then
	file_true_edges=$2		
else
	file_true_edges="/projects/btl_scratch/aafshinfard/projects/physlr2/extra/ground_truth/f1chr4_edges_GT.txt"
fi
printf "\n ##################################################################################"
printf "\n #### label edges of an input overlap graph based on the ground truth "
printf "\n Overlap file:\n ${file_overlap}.tsv"
