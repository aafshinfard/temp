...
nohup /gsc/btl/linuxbrew/bin/sfdp -Gsize=100 -Goverlap_scaling=200 -Tpdf -o f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.n50.gv.sfdp.pdf f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.n50.gv > sfdp.out
f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.subgraph.tsv
...
nohup env PYTHONPATH=/projects/btl_scratch/aafshinfard/projects/physlr2/physlr /projects/btl/aafshinfard/virtuEnv/pypy3/bin/pypy3 /projects/btl_scratch/aafshinfard/projects/physlr2/physlr/bin/physlr filter --min-component-size=1 -Ogv f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.subgraph.n50.tsv >f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.subgraph.gv 2> gv.out &
nohup /gsc/btl/linuxbrew/bin/sfdp -Gsize=100 -Goverlap_scaling=200 -Tpdf -o f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.n50.gv.sfdp.pdf f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.n50.gv > sfdp.out
f1chr4.k32-w32.n100-1000.c2-x.physlr.overlap.subgraph.tsv
